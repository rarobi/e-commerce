...
@section('content')
    ...
    <section class="whish-list-section pb-6rem">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h3 class="title text-capitalize">whish list</h3>
                </div>
                <div class="col-md-12 wishlist-items">
                            ...
                            <table class="table">
                                ...
                                @foreach($wishlistItems as $wishlistItem)
                                    ...
                                    <span class="product-price">
                                        ...
                                        <td class="text-center">
                                            <a class="item-remove pointer" data-item="{{ $wishlistItem->wishlist_id }}"> <span class="trash"><i class="fas fa-trash-alt"></i> </span></a>
                                        </td>

                                        <td class="text-center">
                                            {!! Form::hidden('quantity',1,['class'=>'qty-input']) !!}
                                            <button class="btn btn-primary rounded mt-5 mt-sm-0 add-to-cart-wishlist-item" wishlist-id="{{ $wishlistItem->wishlist_id }}" product-id="{{ $wishlistItem->id }}" data-toggle="modal" data-target="#right_modal_sm">
...
@section('footer-script')
    ...
    $(document.body).ready(function () {
        $('.add-to-cart-wishlist-item').click(function (e) {
