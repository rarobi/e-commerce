    ...
    <div class="card">
        <div class="card-header">
            <div class="row col-sm">
                <h5><i class="fa fa-plus-square"></i> Add Product Brand</h5>
            </div>
        </div>
        {!! Form::open(['route'=>'admin.product.brands.store', 'method'=>'post','enctype'=>'multipart/form-data','id'=>'dataForm']) !!}
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-4 form-group">
                    ...
                    {!! Form::text('website','',['class'=>$errors->has('website')?'form-control is-invalid':'form-control required','rows'=>'2','placeholder'=>'Website link']) !!}
                </div>
                <div class="col-md-4 form-group">
