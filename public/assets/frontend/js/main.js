(function($) {
    ...
    /******************************
     SUBSCRIPTION SCRIPT START HERE
     *****************************/

    $( "#subscribeForm" ).on( "submit", function(e) {

        let dataString = $(this).serialize();
        let inputField = $(this).parent().find('.email');

        if(!validateEmail($(inputField).val())){
            alertify.set('notifier','position', 'bottom-left');
            alertify.success(`<strong class="text-white"><span class="fa fa-check-circle"></span> Error!<br/> Enter a valid email address.</strong> `);
        }
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.responseCode == 1) {
                    ...
                    alertify.success(`<strong class="text-white"><span class="fa fa-check-circle"></span> Success!<br/> You have subscribed successfully.</strong> `);
                    $(inputField).val('');
                }
                if (response.responseCode == false) {
                    alertify.set('notifier','position', 'bottom-left');
                    alertify.error(`<strong class="text-white"><span class="fa fa-check-circle"></span> Sorry!<br/> You have already subscribed.</strong> `);
                }
            }
        });
    ...
    /*********************************
     VALID EMAIL CHECKING SCRIPT HERE
     ********************************/
